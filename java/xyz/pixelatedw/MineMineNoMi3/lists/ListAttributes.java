...
public class ListAttributes 
{
	...
	public static AbilityAttribute YANAGIMOCHI = new AbilityAttribute("Yanagi Mochi").setAbilityCooldown(5).setAbilityDisplayName("Yanagi Mochi").setProjectileTicks(15).setProjectileDamage(8).setProjectileModel(new ModelFoot()).setProjectileColor("#ffeba3").setProjectileSize(4, 4, 4).setModelOffsets(0, 1, 0).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.moveSlowdown.id, 50, 1));
	public static AbilityAttribute KAKUMOCHI = new AbilityAttribute("Kaku Mochi").setAbilityCooldown(5).setAbilityDisplayName("Kaku Mochi").setProjectileModel(new ModelFist()).setProjectileSize(1.4, 1.4, 1).setModelOffsets(0, .5, 0).setProjectileColor("#ffeba3").setProjectileDamage(8).setProjectileTicks(7).setAbilityCharges(40).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.moveSlowdown.id, 50, 1 ));
	public static AbilityAttribute YAKIMOCHI = new AbilityAttribute("Yaki Mochi").setAbilityCooldown(8).setAbilityDisplayName("Yaki Mochi").setProjectileModel(new ModelFist()).setProjectileSize(2, 2, 1).setProjectileColor("#ffeba3").setModelOffsets(0, .5, 0).setProjectileDamage(12).setProjectileExplosion(3, true);
    public static AbilityAttribute MOCHITSUKI = new AbilityAttribute("Mochi Tsuki").setAbilityCooldown(12).setAbilityDisplayName("Mochi Tsuki").setProjectileSize(1, 1, 1.5).setProjectileColor("#ffeba3").setProjectileDamage(15).setModelOffsets(0, 0.5, 0).setProjectileTicks(80).setProjectileModel(new ModelTrident()).setAbilityCharges(40);

...
public class ModelYukiRabi extends EntityModel
{
	...
	public ModelYukiRabi()
	{
		...
		this.rightEar = new RendererModel(this, 0, 30);
		...
		this.body3 = new RendererModel(this, 29, 0);
